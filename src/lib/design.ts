export const furniture = {
  sofa: {
    ...
    short: "Sofa",
    subtitle: "A softer place to land.",
    width: 240,
    min: 180,
    max: 300,
    depth: 100,
  ...
  table: {
    ...
    short: "Coffee table",
    subtitle: "At the heart of the room.",
    width: 120,
    min: 80,
    max: 160,
    depth: 73,
...
export const fabrics = {
  olive: {
    name: "Soft olive",
    color: "#878b6c",
    description: "Quiet, earthy, easy to live with.",
  },
  oatmeal: {
    name: "Oatmeal",
    color: "#c7bca5",
    description: "A warm neutral with a natural feel.",
  },
  terracotta: {
    name: "Clay",
    color: "#ac7460",
    description: "A little warmth. A lot of character.",
  },
  teal: {
    name: "Deep teal",
    color: "#345b54",
    description: "Rich color, a beautifully calm presence.",
  },
} as const;
export const woods = {
...
export const rooms = [
  {
    ...
    description:
      "For long conversations, slow Sundays, and everything in between.",
    image: "/images/living.webp",
    alt: "Concept living room with a linen sofa, walnut coffee table and lounge chair",
    category: "Living room",
  },
  {
    id: "bedroom",
    name: "Bedroom",
    label: "Your everyday retreat.",
    description:
      "Soft textures and thoughtful details. A space that feels entirely yours.",
    image: "/images/bedroom.webp",
    alt: "Concept bedroom with a bespoke upholstered bed and walnut bedside tables",
    category: "Bedroom",
  },
  {
    id: "dining",
    name: "Dining",
    label: "Made for gathering.",
    description:
      "A place for shared meals, familiar faces, and one more cup of tea.",
    image: "/images/dining.webp",
    alt: "Concept dining room with an oval walnut table and upholstered chairs",
...
export function parseDesign(raw: string | null): Design | null {
  ...
  try {
    ...
    if (
      ...
      !Object.hasOwn(furniture, d.product) ||
      typeof d.fabric !== "string" ||
      !Object.hasOwn(fabrics, d.fabric) ||
      typeof d.wood !== "string" ||
      !Object.hasOwn(woods, d.wood)
    )
      return null;
    ...
    if (
      ...
      d.width < furniture[product].min ||
      d.width > furniture[product].max
    )
      return null;
    return {
      product,
      fabric: d.fabric as Design["fabric"],
      wood: d.wood as Design["wood"],
...
export function loadDesign(): Design | null {
  try {
    return parseDesign(localStorage.getItem(storageKey));
  } catch {
    return null;
  }
}
...
export function buildInquiry(design: Design, inquiry: Inquiry): string {
  ...
  return [
    ...
    inquiry.includeDesign
      ? `My illustrative design direction: ${piece.name}, ${design.width} cm wide${piece.upholstered ? `, ${fabrics[design.fabric].name} upholstery` : ""}, ${woods[design.wood].name}.`
      : "",
    inquiry.roomSize.trim()
      ? `Approximate space: ${inquiry.roomSize.trim()}.`
      : "",
